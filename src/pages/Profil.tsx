      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
        ...
        <div className="md:col-span-4">
          <BentoCard className="h-full flex flex-col items-center justify-center bg-gradient-to-br from-[#4361EE] to-[#4CC9F0] text-white p-0 overflow-hidden group">
            <img
              src="https://res-console.cloudinary.com/dbc8npin5/thumbnails/transform/v1/image/upload/Y19maWxsLGhfMjAwLHdfMjAw/v1/U2hhaG5hel9HcmFkLTIyXzIuSlBHX2wxNWpvOQ==/template_primary"
              alt="Profile"
